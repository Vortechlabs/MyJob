...
function ImagePlaceholder() {
  return (
    <div>
           <div role="status" className="mx-auto px-5 py-10 sm:px-10 md:px-12 lg:px-10  max-w-7xl space-y-8 animate-pulse md:space-y-0 md:space-x-8 rtl:space-x-reverse md:flex md:items-center">
